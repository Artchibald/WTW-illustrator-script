  ...
  try {
    function saveAsPNGAt24x24ByDimensions(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        let pngFile = new File(
          `${sourceDoc.path}/${nameByDimensions}/${name24x24}/${iconLayer.name}--${layerName}--24-PNG.png`
        );
    ...
    function saveAsPNGAt32x32ByDimensions(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByDimensions}/${name32x32}/${iconLayer.name}--${layerName}--32-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt48x48ByDimensions(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByDimensions}/${name48x48}/${iconLayer.name}--${layerName}--48-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt64x64ByDimensions(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByDimensions}/${name64x64}/${iconLayer.name}--${layerName}--64-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt300x300ByDimensions(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByDimensions}/${name300x300}/${iconLayer.name}--${layerName}--300-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt512x512ByDimensions(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByDimensions}/${name512x512}/${iconLayer.name}--${layerName}--512-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsSVGByDimensions(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        let aiFile = new File(
          `${sourceDoc.path}/${sourceDoc.name}--SVG`
        );
    ...
    function saveAsPNGAt24x24ByIcon(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByIcon}/${iconLayer.name}/${name24x24}/${iconLayer.name}--${layerName}--24-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt32x32ByIcon(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByIcon}/${iconLayer.name}/${name32x32}/${iconLayer.name}--${layerName}--32-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt48x48ByIcon(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByIcon}/${iconLayer.name}/${name48x48}/${iconLayer.name}--${layerName}--48-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt64x64ByIcon(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByIcon}/${iconLayer.name}/${name64x64}/${iconLayer.name}--${layerName}--64-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt300x300ByIcon(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByIcon}/${iconLayer.name}/${name300x300}/${iconLayer.name}--${layerName}--300-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt512x512ByIcon(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByIcon}/${iconLayer.name}/${name512x512}/${iconLayer.name}--${layerName}--512-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
 ...
 ***********************************/
    function saveAsPNGAt24x24ByColor(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByColor}/${layerName}/${name24x24}/${iconLayer.name}--${layerName}--24-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt32x32ByColor(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByColor}/${layerName}/${name32x32}/${iconLayer.name}--${layerName}--32-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt48x48ByColor(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByColor}/${layerName}/${name48x48}/${iconLayer.name}--${layerName}--48-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt64x64ByColor(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByColor}/${layerName}/${name64x64}/${iconLayer.name}--${layerName}--64-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt300x300ByColor(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByColor}/${layerName}/${name300x300}/${iconLayer.name}--${layerName}--300-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
    ...
    function saveAsPNGAt512x512ByColor(layerName) {
      for (let j = 0; j < myIconsSublayers.length; j++) {
        ...
        iconLayer.visible = true;
        let pngFile = new File(
          `${sourceDoc.path}/${nameByColor}/${layerName}/${name512x512}/${iconLayer.name}--${layerName}--512-PNG.png`
        );
        let type = ExportType.PNG24;
        let opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
   ...
   ***********************************/
  for (let i = 0; i < myColorsLayer.layers.length; i++) {
    let bgLayer = myColorsLayer.layers[i];
