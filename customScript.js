try {
    function saveAsPNGAt512x512IconBg1() {
        var pngFile = new File(app.activeDocument.path + "/512x512/" + "icon1" + bgLayer1.name + ".png");
    ...
    function saveAsPNGAt512x512IconBg2() {
        var pngFile = new File(app.activeDocument.path + "/512x512/" + "icon2" + bgLayer2.name + ".png");
        var type = ExportType.PNG24;
        var opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
        ExportOptionsPNG24.transparency = true;
    ...
    function saveAsPNGAt512x512IconBg3() {
        var pngFile = new File(app.activeDocument.path + "/512x512/" + "icon3" + bgLayer3.name + ".png");
        var type = ExportType.PNG24;
        var opts = new ExportOptionsPNG24();
        ExportOptionsPNG24.antiAliasing = false;
        ExportOptionsPNG24.transparency = true;
